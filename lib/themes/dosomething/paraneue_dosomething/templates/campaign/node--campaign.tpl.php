...
<article class="campaign campaign--action">
  ...
  <section id="prove" class="container container--prove inline-alt-background-color">
    ...
    <div class="wrapper">
      ...
      <div id="reportback" class="reportback" data-nid="<?php print $campaign->nid; ?>" data-prefetched="<?php print count($reportbacks_gallery['items']); ?>" data-ids="<?php print implode(',', $reportbacks_gallery['item_ids']); ?>" data-total="<?php print $reportbacks_gallery['total_remaining']; ?>" data-admin="<?php print $reportbacks_gallery['admin_access']; ?>">
        <div class="wrapper">
