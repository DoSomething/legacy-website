      ...
      <div class="wrapper">
        <?php if( $show_new_reportback ): ?>
          ...
          <ul class="gallery">
            ...
            <li>
              <figure class="media -stacked -framed">
                <img src="http://placeimg.com/300/300/tech" alt="aminals" />
                <figcaption class="__copy">Lorem ipsum dolor sit amet, consectetur adipisicing.</figcaption>
              </figure>
            </li>
            <li>
              <figure class="media -stacked -framed">
                <img src="http://placeimg.com/300/300/arch" alt="aminals" />
                <figcaption class="__copy">Lorem ipsum dolor sit.</figcaption>
              </figure>
            </li>
            <li>
              <figure class="media -stacked -framed">
                <img src="http://placeimg.com/300/300/nature" alt="aminals" />
                <figcaption class="__copy">Lorem ipsum dolor sit amet, consectetur.</figcaption>
              </figure>
            </li>
          </ul>

          <form class="reportback" enctype="multipart/form-data" action="#" method="post" id="dosomething-reportback-form" accept-charset="UTF-8">
            <div>
