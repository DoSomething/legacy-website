<section class="container mcc--googleform">
  <div class="wrapper">
    ...
    <form class="container__block" action="https://docs.google.com/a/dosomething.org/forms/d/1YY2BTXz65IcqyjaTf6GT8FZx0Z2E1251LcSf5LIhc0s/formResponse" method="post" id="ss-form" target="_self" onsubmit="">
      <p class="required">
        ...
        <div dir="ltr" class="ss-item ss-item-required ss-text">
          <div class="ss-form-entry">
            <div class="ss-q-title">
              <label class="field-label ss-q-item-label" for="entry_212037837">First Name <span class="ss-required-asterisk">*</span></label>
            </div>
            <div class="ss-q-help ss-secondary-text" dir="ltr"></div><input type="text" name="entry.212037837" value="" class="text-field ss-q-short" id="entry_212037837" dir="auto" aria-label="First Name" aria-required="true" required="" title="">
      ...
      <div class="ss-form-question errorbox-good -compact -beta">
        <div dir="ltr" class="ss-item ss-item-required ss-text">
          <div class="ss-form-entry">
            <div class="ss-q-title">
              <label class="field-label ss-q-item-label" for="entry_2068859039">Last Name <span class="ss-required-asterisk">*</span></label>
            </div>
            <div class="ss-q-help ss-secondary-text" dir="ltr"></div><input type="text" name="entry.2068859039" value="" class="text-field ss-q-short" id="entry_2068859039" dir="auto" aria-label="Last Name" aria-required="true" required="" title="">
      ...
      <div class="ss-form-question errorbox-good -compact -alpha">
        <div dir="ltr" class="ss-item ss-item-required ss-text">
          <div class="ss-form-entry">
            <div class="ss-q-title">
              <label class="field-label ss-q-item-label" for="entry_1282358104">Email Address <span class="ss-required-asterisk">*</span></label>
            </div>
            <div class="ss-q-help ss-secondary-text" dir="ltr"></div><input type="text" name="entry.1282358104" value="" class="text-field ss-q-short" id="entry_1282358104" dir="auto" aria-label="Email Address" aria-required="true" required="" title="">
      ...
      <div class="ss-form-question errorbox-good -compact -beta">
        <div dir="ltr" class="ss-item ss-item-required ss-text">
          <div class="ss-form-entry">
            <div class="ss-q-title">
              <label class="field-label ss-q-item-label" for="entry_35169248">Cell Number <span class="ss-required-asterisk">*</span></label>
            </div>
            <div class="ss-q-help ss-secondary-text" dir="ltr"></div><input type="text" name="entry.35169248" value="" class="text-field ss-q-short" id="entry_35169248" dir="auto" aria-label="Cell Number" aria-required="true" required="" title="">
      ...
      <div class="ss-form-question errorbox-good">
        <div dir="ltr" class="ss-item ss-item-required ss-date">
          <div class="ss-form-entry">
            <div class="ss-q-title">
              <label class="field-label ss-q-item-label" for="entry_164235794"><?php print t('Birthday'); ?> <span class="ss-required-asterisk">*</span></label>
            </div>
      ...
      <div class="ss-form-question errorbox-good">
          <div dir="ltr" class="ss-item ss-item-required ss-text">
              <div class="ss-form-entry">
                  <div class="ss-q-title">
                      <label class="label-field ss-q-item-label" for="entry_429981564">Where are you located? <span class="ss-required-asterisk">*</span></label>
                  </div>
                  <div class="ss-q-help ss-secondary-text" dir="ltr">
                      Please provide your (valid!) Zip Code.
                  </div><input type="text" name="entry.429981564" value="" class="text-field ss-q-short" id="entry_429981564" dir="auto" aria-label="Where are you located? Please provide your (valid!) Zip Code." aria-required="true" required="" title="">
