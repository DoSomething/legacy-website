          ...
          <div role="list" class="ss-question-list">
            <div class="ss-form-question errorbox-good -compact -alpha" role="listitem">
              <div dir="ltr" class="ss-item ss-item-required ss-text">
                ...
                <div class="ss-form-entry">
                  ...
                  <input type="text" name="entry.212037837" value="" class="ss-q-short" id="entry_212037837" dir="auto" aria-label="First Name  " aria-required="true" required="" title="">
            ...
            <div class="ss-form-question errorbox-good -compact -beta" role="listitem">
              <div dir="ltr" class="ss-item ss-item-required ss-text">
                <div class="ss-form-entry">
                  ...
                  <div class="ss-q-help ss-secondary-text" dir="ltr"></div>
                  <input type="text" name="entry.2068859039" value="" class="ss-q-short" id="entry_2068859039" dir="auto" aria-label="Last Name  " aria-required="true" required="" title="">
                  <div class="error-message"></div>
                  <div class="required-message">This is a required question</div>
                </div>
              </div>
            ...
            <div class="ss-form-question errorbox-good" role="listitem">
              <div dir="ltr" class="ss-item ss-item-required ss-text">
                <div class="ss-form-entry">
                  ...
                  <div class="ss-q-help ss-secondary-text" dir="ltr">Please provide your Zip Code.</div>
                  <input type="text" name="entry.429981564" value="" class="ss-q-short" id="entry_429981564" dir="auto" aria-label="Where are you located? Please provide your Zip Code. " aria-required="true" required="" title="">
                  <div class="error-message"></div>
                  <div class="required-message">This is a required question</div>
                </div>
              </div>
            ...
            <div class="ss-form-question errorbox-good" role="listitem">
              <div dir="ltr" class="ss-item ss-item-required ss-radio">
                <div class="ss-form-entry">
                  <div class="ss-q-title">
                    <label class="ss-q-item-label" for="entry_885457401">Can your idea be completed in one day?<span class="ss-required-asterisk">*</span></label>
                  </div>
                  <div class="ss-q-help ss-secondary-text" dir="ltr"></div>
                  <ul class="ss-choices" role="radiogroup" aria-label="Can your idea be completed in one day?  ">
                    <li class="ss-choice-item">
                      <label><span class="ss-choice-item-control goog-inline-block"><input type="radio" name="entry.980282842" value="Yes" id="group_980282842_1" role="radio" class="ss-q-radio" aria-label="Yes" required="" aria-required="true"></span><span class="ss-choice-label">Yes</span></label>
                    </li>
                    <li class="ss-choice-item">
                      <label><span class="ss-choice-item-control goog-inline-block"><input type="radio" name="entry.980282842" value="No" id="group_980282842_2" role="radio" class="ss-q-radio" aria-label="No" required="" aria-required="true"></span><span class="ss-choice-label">No</span></label>
                    </li>
                  </ul>
                   <div class="error-message"></div>
                   <div class="required-message">This is a required question</div>
            ...
            <div class="ss-form-question errorbox-good" role="listitem">
              <div dir="ltr" class="ss-item ss-item-required ss-paragraph-text">
                <div class="ss-form-entry">
                  ...
                  <div class="ss-q-help ss-secondary-text" dir="ltr">
                    You MUST include a fact/statistic that proves this problem. E.g. X% of animals end up in shelters after hurricanes.
                  </div>
            ...
            <div class="ss-form-question errorbox-good" role="listitem">
              <div dir="ltr" class="ss-item ss-item-required ss-paragraph-text">
                <div class="ss-form-entry">
                  ...
                  <div class="ss-q-help ss-secondary-text" dir="ltr">
                    Your idea should be based on research.<br>
            ...
            <div class="ss-form-question errorbox-good" role="listitem">
              <div dir="ltr" class="ss-item ss-item-required ss-paragraph-text">
                <div class="ss-form-entry">
                  ...
                  <div class="ss-q-help ss-secondary-text" dir="ltr">
                    This should be one clear action someone could complete in one day. E.g., “Collect gently used towels and deliver them to your local animal shelter.”
                  </div>
                  <textarea name="entry.334582054" rows="8" cols="0" class="ss-q-long" id="entry_334582054" dir="auto" aria-label="What exactly do you want people to do? This should be one clear action where the benefit can been seen after one day. e.g. collect gently used towels in your neighborhood and deliver them to your local animal shelter for shelter dogs. Must be fewer than 175 characters." aria-required="true" required=""></textarea>
                  <div class="error-message">
                    Must be fewer than 175 characters.
                  </div>
