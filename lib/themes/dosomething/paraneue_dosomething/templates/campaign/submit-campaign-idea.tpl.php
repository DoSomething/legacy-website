          ...
          <div role="list" class="ss-question-list">
              ...
              <div dir="ltr" class="ss-item ss-item-required ss-text">
                <div class="ss-form-entry">
                  <div class="ss-q-title">
                    <label class="ss-q-item-label" for="entry_212037837">First and Last Name <span class="ss-required-asterisk">*</span></label>
                  </div>

                  <div class="ss-q-help ss-secondary-text" dir="ltr"></div>

                  <input type="text" name="entry.212037837" value="" class="ss-q-short" id="entry_212037837" dir="auto" aria-label="First and Last Name" aria-required="true" required="" title="" />
            ...
            <div class="ss-form-question errorbox-good" role="listitem">
              <div dir="ltr" class="ss-item ss-item-required ss-date">
                <div class="ss-form-entry">
                  <div class="ss-q-title">
                    <label class="ss-q-item-label" for="entry_164235794">Birthday<span class="ss-required-asterisk">*</span></label>
                  </div>

                  <div class="ss-q-help ss-secondary-text" dir="ltr">
                    Must be 13-25 in order to be considered a member of DoSomething.org.
                  </div>
                  ...
                  <div class="ss-q-date">
                    <div class="ss-datetime-box goog-inline-block">
                      ...
                      <select name="entry.164235794_day" class="ss-day-dropdown" id="entry.164235794_day" aria-label="Day of month" aria-required="true">
            ...
            <div class="ss-form-question errorbox-good" role="listitem">
              <div dir="ltr" class="ss-item ss-item-required ss-radio">
                <div class="ss-form-entry">
                  <div class="ss-q-title">
                    <label class="ss-q-item-label" for="entry_1031662904">What cause area does your idea focus on? <span class="ss-required-asterisk">*</span></label>
                  </div>

                  <div class="ss-q-help ss-secondary-text" dir="ltr">
                    If your idea addresses more than one cause, choose the one that is most relevant. e.g if your campaign is about helping dogs (Animals) after a hurricane (Environment), choose Animals.
                  </div>
            ...
            <div class="ss-form-question errorbox-good" role="listitem">
              <div dir="ltr" class="ss-item ss-item-required ss-radio">
                <div class="ss-form-entry">
                  <div class="ss-q-title">
                    <label class="ss-q-item-label" for="entry_223902718">What type of action does your idea fall under? <span class="ss-required-asterisk">*</span></label>
                  </div>

                  <div class="ss-q-help ss-secondary-text" dir="ltr">
                    See <a href="https://docs.google.com/a/dosomething.org/file/d/0B5fENCbpVZv9R0VnMjh5VWJybFB1QTRyRS05clF3V19VdkFj/edit">descriptions of all campaign types</a>. If your idea has more than one type of action, choose the one that is most relevant. e.g if your campaign idea is an event (host an event) where people donate a piece of clothing as admission (donate an item), choose host an event.
                  </div>
            ...
            <div class="ss-form-question errorbox-good" role="listitem">
              <div dir="ltr" class="ss-item ss-item-required ss-paragraph-text">
                <div class="ss-form-entry">
                  ...
                  <div class="ss-q-help ss-secondary-text" dir="ltr">
                    All of our campaigns are based on research.<br>
                    Include: <br>
                    1. Title of specific study, article, website, or book <br>
                    2.Organization or author that published it <br>
                    3. Link to study or stat.
                  </div>
            ...
            <div class="ss-form-question errorbox-good" role="listitem">
              <div dir="ltr" class="ss-item ss-item-required ss-paragraph-text">
                <div class="ss-form-entry">
                  ...
                  <div class="ss-q-help ss-secondary-text" dir="ltr">
                    This should be one clear action (remember you should be able to complete this in one day). e.g. collect gently used towels in your neighborhood and deliver them to your local animal shelter for shelter dogs. (Limit 175 characters).
                  </div>
                  <textarea name="entry.334582054" rows="8" cols="0" class="ss-q-long" id="entry_334582054" dir="auto" aria-label="What exactly do you want people to do? This should be one clear action where the benefit can been seen after one day. e.g. collect gently used towels in your neighborhood and deliver them to your local animal shelter for shelter dogs. Must be fewer than 175 characters." aria-required="true" required="">
                  </textarea>
            ...
            <div class="ss-form-question errorbox-good" role="listitem">
              <div dir="ltr" class="ss-item ss-item-required ss-paragraph-text">
                <div class="ss-form-entry">
                  <div class="ss-q-title">
                    <label class="ss-q-item-label" for="entry_2116830440">What proof do you have that your idea is an effective solution to the problem you’re addressing? <span class="ss-required-asterisk">*</span></label>
                  </div>

                  <div class="ss-q-help ss-secondary-text" dir="ltr">
                    You MUST be able to prove that this solution will help solve the problem above. You can do this by telling us about your project (if you’ve done this before) OR by linking to research that proves that your solution is valid. e.g. “I run this project in my town every Christmas and last year we fed 100 people.” OR e.g. "The CDC says that educating people about vaccines makes them more likely to get vaccinated." (Limit 175 characters).
                  </div>
            ...
            <div class="ss-form-question errorbox-good" role="listitem">
              <div dir="ltr" class="ss-item ss-paragraph-text">
                <div class="ss-form-entry">
                  ...
                  <div class="ss-q-help ss-secondary-text" dir="ltr"></div>
                  <textarea name="entry.767078954" rows="8" cols="0" class="ss-q-long" id="entry_767078954" dir="auto" aria-label="Anything else you'd like to add?">
                  </textarea>
