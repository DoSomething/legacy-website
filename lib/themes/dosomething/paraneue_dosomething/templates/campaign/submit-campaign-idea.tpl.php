  <div class="ss-form-container">
    <div class="ss-header-image"></div>

    <div class="ss-top-of-page">
      <div class="ss-form-heading">
        <h1 class="ss-form-title" dir="ltr">The Hunt Member Created Campaigns Form</h1>

        <div class="ss-form-desc ss-no-ignore-whitespace">
          Please fill out the following questions by FRIDAY, JUNE 20TH if you are
          ...
          before submitting. CAMPAIGNS MUST MEET THESE REQUIREMENTS TO BE ELIGIBLE.
        </div>
    ...
    <div class="ss-form">
      ...
      method="post" id="ss-form" target="_self" onsubmit="">
        <div role="list" class="ss-question-list" style=
        "margin-left: 2em; padding-left: 0">
          <div class="ss-form-question errorbox-good" role="listitem">
            <div dir="ltr" class="ss-item ss-item-required ss-text">
              <div class="ss-form-entry">
                <div class="ss-q-title">
                  <label class="ss-q-item-label" for="entry_212037837">First and Last
                  Name <span class="ss-required-asterisk">*</span></label>
                </div>

                <div class="ss-q-help ss-secondary-text" dir="ltr"></div><input type=
                "text" name="entry.212037837" value="" class="ss-q-short" id=
                "entry_212037837" dir="auto" aria-label="First and Last Name"
          ...
          <div class="ss-form-question errorbox-good" role="listitem">
            <div dir="ltr" class="ss-item ss-item-required ss-text">
              <div class="ss-form-entry">
                <div class="ss-q-title">
                  <label class="ss-q-item-label" for="entry_1282358104">Email Address
                  <span class="ss-required-asterisk">*</span></label>
                </div>

                <div class="ss-q-help ss-secondary-text" dir="ltr"></div><input type=
                "text" name="entry.1282358104" value="" class="ss-q-short" id=
                "entry_1282358104" dir="auto" aria-label="Email Address" aria-required=
                "true" required="" title="" />
          ...
          <div class="ss-form-question errorbox-good" role="listitem">
            <div dir="ltr" class="ss-item ss-item-required ss-text">
              <div class="ss-form-entry">
                <div class="ss-q-title">
                  <label class="ss-q-item-label" for="entry_35169248">Phone Number
                  <span class="ss-required-asterisk">*</span></label>
                </div>

                <div class="ss-q-help ss-secondary-text" dir="ltr"></div><input type=
                "text" name="entry.35169248" value="" class="ss-q-short" id=
                "entry_35169248" dir="auto" aria-label="Phone Number" aria-required=
                "true" required="" title="" />
          ...
          <div class="ss-form-question errorbox-good" role="listitem">
            <div dir="ltr" class="ss-item ss-item-required ss-date">
              <div class="ss-form-entry">
                <div class="ss-q-title">
                  <label class="ss-q-item-label" for="entry_164235794">Date of Birth
                  <span class="ss-required-asterisk">*</span></label>
                </div>

                <div class="ss-q-help ss-secondary-text" dir="ltr">
                  To ensure you are within the ages of 13-25 (DoSomething.org member age)
                </div>

                <div class="ss-q-date">
                  <div class="ss-datetime-box goog-inline-block">
                    <select name="entry.164235794_month" class="ss-month-dropdown" id=
                    "entry.164235794_month" aria-label="Month" aria-required="true">
                      <option value="">
                        Month
                      </option>
                    ...
                    </select> <select name="entry.164235794_day" class="ss-day-dropdown"
                    id="entry.164235794_day" aria-label="Day of month" aria-required=
                    "true">
                      <option value="">
                        Day
                      </option>
                    ...
                    </select> <select name="entry.164235794_year" id=
                    "entry.164235794_year" aria-label="Year" aria-required="true">
                      <option value="">
                        Year
                      </option>
                          ...
                          <table cellspacing="0" cellpadding="0">
                            ...
                            <tfoot>
                              <tr class="goog-date-picker-foot">
                                ...
                                <button class=
                                "goog-date-picker-btn goog-date-picker-today-btn">Today</button></td>

                                <td colspan="3"></td>

                                <td colspan="2" class="goog-date-picker-none-cont">
                                <button class=
                                "goog-date-picker-btn goog-date-picker-none-btn">None</button></td>
                              </tr>
                            </tfoot>
                          </table>
                        </div>
          ...
          <div class="ss-form-question errorbox-good" role="listitem">
            <div dir="ltr" class="ss-item ss-item-required ss-radio">
              <div class="ss-form-entry">
                <div class="ss-q-title">
                  <label class="ss-q-item-label" for="entry_1031662904">What cause are
                  you focusing on? <span class="ss-required-asterisk">*</span></label>
                </div>

                <div class="ss-q-help ss-secondary-text" dir="ltr">
                  If your call to action addresses more than one cause, choose the one
                  that is most relevant. e.g if your campaign is about helping dogs
                  (Animals) after a hurricane (Environment), choose Animals.
                </div>
          ...
          <div class="ss-form-question errorbox-good" role="listitem">
            <div dir="ltr" class="ss-item ss-item-required ss-radio">
              <div class="ss-form-entry">
                <div class="ss-q-title">
                  <label class="ss-q-item-label" for="entry_223902718">What type of
                  campaign are you creating? <span class=
                ...
                <li class="ss-choice-item"><label><span class=
                "ss-choice-item-control goog-inline-block"><input type="radio" name=
                "entry.101412798" value="Donate an item" id="group_101412798_1" role=
                "radio" class="ss-q-radio" aria-label="Donate an item" required=""
                aria-required="true" /></span> <span class="ss-choice-label">Donate an
                item</span></label></li>

                  <li class="ss-choice-item"><label><span class=
                  "ss-choice-item-control goog-inline-block"><input type="radio" name=
                  "entry.101412798" value="Improve/clean up a (physical) space" id=
                  "group_101412798_2" role="radio" class="ss-q-radio" aria-label=
                  "Improve/clean up a (physical) space" required="" aria-required=
                  "true" /></span> <span class="ss-choice-label">Improve/clean up a
                  (physical) space</span></label></li>

                  <li class="ss-choice-item"><label><span class=
                  "ss-choice-item-control goog-inline-block"><input type="radio" name=
                  "entry.101412798" value="Face to face" id="group_101412798_3" role=
                  "radio" class="ss-q-radio" aria-label="Face to face" required=""
                  aria-required="true" /></span> <span class="ss-choice-label">Face to
                  face</span></label></li>

                  <li class="ss-choice-item"><label><span class=
                  "ss-choice-item-control goog-inline-block"><input type="radio" name=
                  "entry.101412798" value="Host an event" id="group_101412798_4" role=
                  "radio" class="ss-q-radio" aria-label="Host an event" required=""
                  aria-required="true" /></span> <span class="ss-choice-label">Host an
                  event</span></label></li>

                  <li class="ss-choice-item"><label><span class=
                  "ss-choice-item-control goog-inline-block"><input type="radio" name=
                  "entry.101412798" value="Take a stand" id="group_101412798_5" role=
                  "radio" class="ss-q-radio" aria-label="Take a stand" required=""
                  aria-required="true" /></span> <span class="ss-choice-label">Take a
                  stand</span></label></li>

                  <li class="ss-choice-item"><label><span class=
                  "ss-choice-item-control goog-inline-block"><input type="radio" name=
                  "entry.101412798" value="Make something" id="group_101412798_6" role=
                  "radio" class="ss-q-radio" aria-label="Make something" required=""
                  aria-required="true" /></span> <span class="ss-choice-label">Make
                  something</span></label></li>

                  <li class="ss-choice-item"><label><span class=
                  "ss-choice-item-control goog-inline-block"><input type="radio" name=
                  "entry.101412798" value="Start something" id="group_101412798_7" role=
                  "radio" class="ss-q-radio" aria-label="Start something" required=""
                  aria-required="true" /></span> <span class="ss-choice-label">Start
                  something</span></label></li>

                  <li class="ss-choice-item"><label><span class=
                  "ss-choice-item-control goog-inline-block"><input type="radio" name=
                  "entry.101412798" value="Share something" id="group_101412798_8" role=
                  "radio" class="ss-q-radio" aria-label="Share something" required=""
                  aria-required="true" /></span> <span class="ss-choice-label">Share
                  something</span></label></li>
                </ul>
          ...
          <div class="ss-form-question errorbox-good" role="listitem">
            <div dir="ltr" class="ss-item ss-item-required ss-paragraph-text">
              <div class="ss-form-entry">
                <div class="ss-q-title">
                  <label class="ss-q-item-label" for="entry_1255883103">What problem are
                  you addressing? <span class="ss-required-asterisk">*</span></label>
                </div>

                <div class="ss-q-help ss-secondary-text" dir="ltr">
                  You MUST include a fact/statistic that proves this problem. e.g. X% of
                  animals end up in shelters after hurricanes.
                </div>
                <textarea name="entry.1255883103" rows="8" cols="0" class="ss-q-long" id=
                "entry_1255883103" dir="auto" aria-label=
                "What problem are you addressing? You MUST include a fact/statistic that proves this problem. e.g. X% of animals end up in shelters after hurricanes. Must be fewer than 175 characters."
          ...
          <div class="ss-form-question errorbox-good" role="listitem">
            <div dir="ltr" class="ss-item ss-item-required ss-paragraph-text">
              <div class="ss-form-entry">
                <div class="ss-q-title">
                  <label class="ss-q-item-label" for="entry_1631970968">What is the
                  source for this problem? <span class=
                  "ss-required-asterisk">*</span></label>
                </div>

                <div class="ss-q-help ss-secondary-text" dir="ltr">
                  Include: 1. Title of specific study, article, website, or book 2.
                  Organization or author that published it 3. Publication date 4. Link to
                  study or stat. NOTE: The citation should reference the author who
                  created it. e.g. Don't cite a Huffington Post's article about a study
                  or a stat, find the original study or stat and cite that instead.
                </div>
                <textarea name="entry.1631970968" rows="8" cols="0" class="ss-q-long" id=
                "entry_1631970968" dir="auto" aria-label=
                "What is the source for this problem? Include: 1. Title of specific study, article, website, or book 2. Organization or author that published it 3. Publication date 4. Link to study or stat. NOTE: The citation should reference the author who created it. e.g. Don't cite a Huffington Post's article about a study or a stat, find the original study or stat and cite that instead."
                aria-required="true" required="">
  </textarea>
          ...
          <div class="ss-form-question errorbox-good" role="listitem">
            <div dir="ltr" class="ss-item ss-item-required ss-paragraph-text">
              <div class="ss-form-entry">
                <div class="ss-q-title">
                  <label class="ss-q-item-label" for="entry_2116830440">Link to the
                  solution of this problem. <span class=
                  "ss-required-asterisk">*</span></label>
                </div>

                <div class="ss-q-help ss-secondary-text" dir="ltr">
                  You MUST be able to prove that this solution will help solve the
                  problem above. You can do this by telling us about your project (if
                  you&#8217;ve done this before) OR by linking to a research study that
                  proves that your solution is valid. e.g. &#8220;I run this campaign in
                  my town every Christmas and last year we fed 100 people.&#8221; OR e.g.
                  "The CDC says that educating people about vaccines makes them more
                  likely to get them."
                </div>
                <textarea name="entry.2116830440" rows="8" cols="0" class="ss-q-long" id=
                "entry_2116830440" dir="auto" aria-label=
                "Link to the solution of this problem. You MUST be able to prove that this solution will help solve the problem above. You can do this by telling us about your project (if you&#8217;ve done this before) OR by linking to a research study that proves that your solution is valid. e.g. &#8220;I run this campaign in my town every Christmas and last year we fed 100 people.&#8221; OR e.g. &quot;The CDC says that educating people about vaccines makes them more likely to get them.&quot; Must be fewer than 175 characters."
                aria-required="true" required="">
  </textarea>
          ...
          <div class="ss-form-question errorbox-good" role="listitem">
            <div dir="ltr" class="ss-item ss-item-required ss-paragraph-text">
              <div class="ss-form-entry">
                <div class="ss-q-title">
                  <label class="ss-q-item-label" for="entry_334582054">What exactly do
                  you want people to do? <span class=
                  "ss-required-asterisk">*</span></label>
                </div>

                <div class="ss-q-help ss-secondary-text" dir="ltr">
                  This should be one clear action where the benefit can been seen after
                  one day. e.g. collect gently used towels in your neighborhood and
                  deliver them to your local animal shelter for shelter dogs.
                </div>
                <textarea name="entry.334582054" rows="8" cols="0" class="ss-q-long" id=
                "entry_334582054" dir="auto" aria-label=
                "What exactly do you want people to do? This should be one clear action where the benefit can been seen after one day. e.g. collect gently used towels in your neighborhood and deliver them to your local animal shelter for shelter dogs. Must be fewer than 175 characters."
                aria-required="true" required="">
  </textarea>
          ...
          <div class="ss-form-question errorbox-good" role="listitem">
            <div dir="ltr" class="ss-item ss-paragraph-text">
              <div class="ss-form-entry">
                ...
                <textarea name="entry.767078954" rows="8" cols="0" class="ss-q-long" id=
                "entry_767078954" dir="auto" aria-label=
          ...
          "[,,&quot;-2491597392743010610&quot;] " /> <input type="hidden" name=
          "pageHistory" value="0" /> <input type="hidden" name="fbzx" value=
          "-2491597392743010610" />
      ...
      <div class="ss-legal">
        ...
        <div class="disclaimer" dir="ltr">
          <div class="powered-by-logo">
            <span class="powered-by-text">Powered by</span> <a class="ss-logo-link" href=
            "http://drive.google.com?usp=form_footer"><img class="ss-logo" src=
            "https://ssl.gstatic.com/docs/forms/drive_logo_small2.png" alt=
            "Google Drive" /></a>
          </div>

          <div class="ss-terms">
            <span class="disclaimer-msg">This form was created inside of Do
            Something.</span><br />
            <a href=
            "https://docs.google.com/forms/d/1PjmkallseEPvmmrJuEyEIgOWTlGThg1ylzxgPZloXfU/reportabuse?source=https://docs.google.com/forms/d/1PjmkallseEPvmmrJuEyEIgOWTlGThg1ylzxgPZloXfU/viewform?edit_requested%3Dtrue">
            Report Abuse</a> - <a href="http://www.google.com/accounts/TOS">Terms of
            Service</a> - <a href=
            "http://www.google.com/google-d-s/terms.html">Additional Terms</a>
          </div>
        </div>
      </div>
    </div>

    <div id="docs-aria-speakable" class=
    "docs-a11y-ariascreenreader-speakable docs-offscreen" aria-live="assertive" role=
    "region" aria-atomic="">
