...
const Signup = {
  ...
  handleSignup: function($button) {
    ...
    $('.signup-button-1').click(function(e) {
      ...
      const promise = _this.postSignup($this, $this.data('campaign-id'));

      ajaxPromise = ajaxPromise.then(function() {
        return promise;
      }).done( function(data){
        console.log('something 1 success');
    ...
    $('.signup-button-2').click(function(e) {
      ...
      ajaxPromise = ajaxPromise.then(function() {
        ...
        console.log('something 2 success');
        _this.successCallback(data);
      });
    });
    ...
    $('.signup-button-3').click(function(e) {
      ...
      ajaxPromise = ajaxPromise.then(function() {
        ...
        console.log('something 3 success');
        _this.successCallback(data);
      });
    });
  },
  postSignup: function($button, campaignId) {
    const _this = this;
  ...
  addSignedUp: function($element, text = null) {
    console.log("addSignedUp");
    const $container = $element.closest('.-signup');
