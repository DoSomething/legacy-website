...
function isOnboardingEnabled(localStorageKey) {
  const developerModeEnabled = setting('dsOnboarding.developerModeEnabled', false);
...
$(document).ready(function() {
  ...
  const client = new ApiClient(setting('dsOnboarding.api.version'), setting('dsOnboarding.api.host'), setting('dsOnboarding.api.port'));
  ...
  isOnboardingEnabled(localStorageKey).then(enableOnboarding(localStorageKey, client, user, campaign));
});
