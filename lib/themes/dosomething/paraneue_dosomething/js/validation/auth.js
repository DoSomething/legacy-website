...
module.exports = function(validationFunctions) {
  "use strict";
  ...
  validationFunctions.name = function(string, done) {
    if( string !== "" ) {
      return done({
        success: true,
        message: "Hey, " + string + "!"
  ...
  validationFunctions.birthday = function(string, done) {
  ...
  validationFunctions.email = function(string, done) {
  ...
  validationFunctions.password = function(string, done) {
    if(string.length >= 6) {
      return done({
        success: true,
  ...
  // Matches validation performed in dosomething_user.module.
  validationFunctions.phone = function(string, done) {
