...
$(document).ready(function() {
  ...
  if (Drupal.settings.dsOnboarding.enabled) {
    const elementName = 'jsx-onboarding';
    ...
    $('.chrome').find('> .wrapper').before(`<div id="${elementName}"></div>`);

    ReactDom.render(<Onboarding slides={slides} campaign={campaign} user={user} />, document.getElementById(elementName));
  }
