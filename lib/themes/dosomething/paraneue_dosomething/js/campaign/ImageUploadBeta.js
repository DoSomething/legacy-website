...
define(function(require) {
  ...
  ImageUploadBeta.prototype.init = function () {
    ...
    this.$uploadButton.on("change", function(event) {
      ...
      _this.previewImage(files, _this.$imageWrapper);
   ...
   * @param {jQuery} $imageWrapper The DOM element to put the preview image in.
   */
  ImageUploadBeta.prototype.previewImage = function(files, $imageWrapper) {
    var $imgPreview = $("<img class='preview' src=''>");
    $imageWrapper.html( $imgPreview );
