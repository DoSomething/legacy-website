...
// @TODO - should make a public function that other scripts
// can subscribe to that populates the form.
...
define(function(require) {
   ...
   */
  var populateFields = function(cropValues, degrees) {
  ...
  var dsCropperInit = function(image) {
    ...
    $rotateButton.click(function(e) {
      ...
      populateFields(finalValues, degrees);
    });
  };
