define(function(require) {
  ...
  var cropPreview = function() {
    var $cropPreview = $("<figure class='crop_preview'></figure>");
    ...
    var translateDiff = ($previewImage.width() / 2) - ($previewImage.height() / 2);
    $(".crop_preview .preview").css({
      "left": -(x / (w / 480)) + "px",
      "top": -(y / (h / 480)) + "px",
      "width": $(".preview").width() / (w / 480),
      "height": $(".preview").height() / (h / 480),
      "transform" : "rotate("+ degrees + "deg) translate(" + translateDiff + "px, " + translateDiff + "px)",
    });
