define(["jquery", "app/CampaignResults"], function($, CampaignResults) {
  "use strict";
  ...
  var CampaignFinder = {
    ...
    query: function () {
      ...
      CampaignFinder.xhr = $.ajax({
        ...
        success: function (data) {
          ...
          CampaignFinder.disableFields(data.facetCounts.facetQueries);
        },
     ...
     *
     * @param  {Object} results The Solr facetQueries result
     */
