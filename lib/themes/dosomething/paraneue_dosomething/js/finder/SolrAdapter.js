define(["jquery", "lodash"], function($, _) {
  ...
  var SolrAdapter = {
     ...
     **/
    baseURL: "http://search.dosomething.org/solr/",
    ...
    defaultQuery: [
      ...
      "rows=8",
      "fl=label,tid,im_vid_1,sm_vid_Action_Type,tm_vid_1_names,im_field_cause,im_vid_2,sm_vid_Cause,tm_vid_2_names,im_field_tags,im_vid_5,sm_vid_Tags,tm_vid_5_names,fs_field_active_hours,sm_field_call_to_action,bs_field_staff_pick,ss_field_search_image,url"
    ],
