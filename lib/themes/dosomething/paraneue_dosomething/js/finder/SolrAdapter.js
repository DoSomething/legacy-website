define(["jquery", "lodash"], function($, _) {
  ...
  var SolrAdapter = {
     ...
     */
    throttledQuery: function(checkedFields, offset, successCallback) {
      ...
      SolrAdapter.throttle = setTimeout(function() {
        SolrAdapter.query(checkedFields, offset, successCallback);
     ...
     * @param successCallback   Function called when query successfully completes.
     */
    query: function (checkedFields, offset, successCallback) {
      /**
