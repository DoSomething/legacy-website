define(["jquery", "unveil", "finder/Campaign", "text!finder/templates/no-results.tpl.html"], function($, unveil, Campaign, noResultsTplSrc) {
  "use strict";
  ...
  var ResultsView = {
    ...
    init: function ($div, $blankSlateDiv, paginateAction, clearFormAction) {
      ...
      ResultsView.$div.on('click', '#reset-filters', function(e) {
        e.preventDefault();
