...
class InstructionSlide extends React.Component {
  ...
  render() {
    ...
    const display_competition_message = competition && competition.joined && competition.messages;
          ...
          <div className="wrapper">
            ...
            <div className="container__row">
              <div className="container__block -narrow -centered">
                ...
                {display_competition_message ? <p>{competition.messages.confirmation}</p> : ''}
                <p>{body}</p>
              </div>
            </div>
