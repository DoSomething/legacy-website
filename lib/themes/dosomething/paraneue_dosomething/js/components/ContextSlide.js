...
class ContextSlide extends React.Component {
  ...
  render() {
    return (
      <div className="container slideshow__slide">
        <div className="wrapper">
          ...
          <div className="container__row">
            <div className="container__block">
              ...
              <p>You'll get all the tolls you need to create impact. You've already joing [campaign name]. Now sign up for other popular campaigns!</p>
            </div>
          </div>
