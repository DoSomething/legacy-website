          ...
          <div className="wrapper">
            ...
            <div className="container__row">
              <div className="container__block -primary">
                ...
                <p>Nice! By joining the {this.props.campaign.title} campaign, you've teamed up with 5.3 million other members who are making an impact on the causes affecting your world.</p>
