...
class ReactionsList extends React.Component {
  constructor(props) {
    ...
    this.state = {
      reactions: this.setInitialReactionsState()
    };
  ...
  /**
   * Set new state for component after any updates.
   */
  setReactionsState() {
    this.setState({
  ...
  /**
   * Update the specified reaction state data.
   *
   * @param  {String} termId
