 ...
 * issue #3404) formatted like this:
 *
 ...
 * 3. Execute like this:
 *
 *    drush --script-path=../scripts/ php-script 3647-more-legacy-redirects.php
 */

$DATA_FILE = '../scripts/redirects.still.needed.csv';
...
$OUTPUT_FILE = '../scripts/3647-redirects.legacy.processed.csv';
...
if (FALSE !== ($fh = fopen($DATA_FILE, 'r'))) {
  ...
  while ($row = fgetcsv($fh)) {
    ...
    if (!empty($row[1])) {
      ...
      $source_parts = RedirectHelper3409::parseUrl($row[1]);
